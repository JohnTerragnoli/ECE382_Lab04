...
;	Fall 2014
;	MSP430G2553
;	Puts 8 by 8 block of either white or black pixels on the Nokia LCD display.
;-------------------------------------------------------------------------------
...
;	Outputs:	none
;	Purpose:	draw an 8x8 block of black or white pixels at screeen cordinates	8*row,8*col
...
drawBlock:
	...
	mov		#1, R12
	//this value was the only thing I changed, because r14 is the location for
	//where the next parameter would go in the asm file if another parameter was
	//added from the original code.  The third parameter always goes in r14.
	//(to my knowledge)
	mov		R14, R13
