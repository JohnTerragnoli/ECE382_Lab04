...
;	The block bounces around the screen.  The block and screen color can be
;	inverted by hitting the AUX button.
;-------------------------------------------------------------------------------
...
;	Inputs:		r11, r12, r13
;	Outputs:	none
;	Purpose:	Writes 0x360 black 8-bit columns to the Nokia display
;-------------------------------------------------------------------------------
blackDisplay:
	push	R11
	push	R12
	...
	mov.w	#0x01, R12			; set display address to 0,0
	mov.w	#0x00, R13
	call	#setAddress


	mov.w	#0xFF, R12			; write a "black" set of pixels
